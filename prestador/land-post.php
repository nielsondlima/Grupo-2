    ...
    <header>
        <div class="container">
            ...
            <nav>
                ...
                <a href="land-post.php">Requisição</a>
    ...
    <main class="container">
        <div class="card">
            ...
            <div class="card-description">
                <h3>Fez muito frio semana passada, e acabei abusando do chuveiro elétrico. Acabou que a resistência queimou, e voltou a esfriar.</h3>
                <div class="imagem" id="imagem"> 
                    <img src="https://midias.jornalcruzeiro.com.br/wp-content/uploads/2021/01/chuveiro-547x364.jpg" alt="">
                </div>
            </div>

            <div class="icons-container">
                <button id="button1" onclick="alert('Comentário enviado!');"> 
                    <img src="https://cdn.icon-icons.com/icons2/906/PNG/512/commenting_icon-icons.com_70233.png" alt="">
                </button>
                <button id="button2" onclick="alert('Ação realizada!');"> 
                    <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTrlEOQUDoqYMLLGIc0Sf9R4kTO2SKiXxWADQ&s" alt="">
                </button>
            </div>
